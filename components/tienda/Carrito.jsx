            ...
            <div className="animated fadeIn slow">
              <div className="box carrito">
                ...
                <div className="col l4 m6 s12">
                  <h5 className="center col s12 right-align"> Total a pagar:</h5>
                  <h5 className="center col s12 right-align animated pulse fast"> <FormattedMessage   id="total"  defaultMessage={`$ {total, number}`} values={{total : this.total()}}  /></h5>
                  <p className="center">
                    ...
                    <button className="btn red darken-4 btn-sm"  type="button" onClick={this.vaciarCarrito}><i className="material-icons" style={{'lineHeight' : '14px', 'fontSize': '17px', 'position' : 'relative', 'top': '3px'}} >delete</i> Vaciar Carrito</button>
                  </p>
                </div>
              </div>
            </div>
