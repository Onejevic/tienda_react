...
//-----------------------------------------------------------------------------
  checkLogin(event) {
    ...
    console.log(password);
      if(email === "correo@internet.com" && password === "123456") {
          ...
          <div className="col s6 form-container animated fadeIn slow">
            <form onSubmit={this.checkLogin}>
              ...
              <div className="col s12 input-field">
                <input type="email" ref="email" id="email" value={this.state.email} onChange={this.handleChange} placeholder="correo@internet.com" className="validate white-text" required aria-required="true" />
